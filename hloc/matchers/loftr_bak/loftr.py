...
#     def forward(self, data, matches_path):
#         """ 
#         Update:
#             data (dict): {
...
#             'hw0_raw': data['image0_raw'].shape[2:], 'hw1_raw': data['image1'].shape[2:]
#         })
...
#         matches, scores = self.coarse_matching(feat_c0, feat_c1, data, mask_c0=mask_c0, mask_c1=mask_c1)
#         pred = {}
#         pred['matches0'] = matches
#         pred['matching_scores0'] = scores
#         pair = names_to_pair(data['name0'], data['name1'])
