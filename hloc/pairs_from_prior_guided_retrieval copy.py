...
DEFAULT_DIST_THRESH = 60  # in meters
DEFAULT_ROT_THRESH = 60  # in degrees (option: 90 or 60 or 45)
...
def main(
    ...
    if db_intrinsics:
        images = parse_pose_list(db_intrinsics)  
        db_names = [k for k, _ in images.items()]
    ...
    # time1 = time.time()
    # print("pairs axes prior preprocessing: ", time1 - t_start)    
