...
class ImagePairDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, image_db_dir, image_query_dir, conf, pairs):
    ...
    def __getitem__(self, idx):
        ...
        if self.conf.cache_images:
            ...
            image0 = read_image(self.image_query_dir / name0, self.conf.grayscale)
            image1 = read_image(self.image_db_dir / name1, self.conf.grayscale)
...
def match_dense(conf: Dict,
    ...
    dataset = ImagePairDataset(image_db_dir, image_query_dir, conf["preprocessing"], pairs)
...
def match_and_assign(conf: Dict,
    ...
    match_dense(conf, pairs, image_db_dir, image_query_dir, match_path,
...
def main(conf: Dict,
    ...
    match_and_assign(conf, pairs, image_db_dir, image_query_dir, matches,
