...
def main(
    ...
    for qname, query_camera in tqdm(queries):
        ...
        points2D_q_all = get_keypoints(features_query, qname)
        points2D_q_all += 0.5
        ...
        for i in range(len(db_names)):
            ...
            # valid = matches > -1
            points2D_q = points2D_q_all[matches[:, 0]]
            ...
            if i == 0:
                ...
                if len(points3D_db) != 0:
                    ...
                    # for i in range(len(points3D_db)):
                    #     if points2D_q[i] not in temp_2D_points_q:
                    #         temp_3D_points_db = np.vstack((temp_3D_points_db, points3D_db[i]))
                    #         temp_2D_points_q = np.vstack((temp_2D_points_q, points2D_q[i]))
            
           
            # print(len(temp_3D_points_db))
