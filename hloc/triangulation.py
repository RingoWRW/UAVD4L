...
def import_matches(image_ids, database_path, pairs_path, matches_path,
                   min_match_score=None, skip_geometric_verification=False, sample_step=1):
    ...
    for name0, name1 in tqdm(pairs):
        ...
        matches = matches[::sample_step]
        scores = scores[::sample_step]
        if min_match_score:
...
def main(sfm_dir, reference_model, image_dir, pairs, features, matches,
         skip_geometric_verification=False, estimate_two_view_geometries: bool = False,min_match_score=None,
         verbose=False, sample_step=1):
    ...
    import_matches(image_ids, database, pairs, matches,
                   min_match_score, skip_geometric_verification, sample_step)
