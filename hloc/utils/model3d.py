...
from .read_write_model import weighted_pose
...
class Model3D:
    def __init__(self, path):
        ...
        self.id2name = {i.id: i.name for i in self.dbs.values()}
    ...
    def covisibility(self, dbids):
        clusters = do_covisibility_clustering(dbids, self.dbs, self.points3D)
        return clusters

    def pose_approximation(self, qname, dbids, global_descriptors, alpha=1):
        """Described in:
