...
# obj_path = '/media/guan/data/CityofStars/Production_1_obj/Data'
...
obj_path = str(sys.argv[-8])
depth_save_path = str(sys.argv[-9])
origin_coord = [401448,3131258,0]
...
all_tile_name = tile_name

for obj_index in range(len(all_tile_name)):
    obj_path_file = obj_path + '/' + all_tile_name[obj_index] + '/' + all_tile_name[obj_index] + '.obj'
    
    if os.path.exists(obj_path_file):
        # 加载
        
        bpy.ops.import_scene.obj(filepath=obj_path_file)
