...
from hloc import extract_features, match_dense,extract_global_features_db,extract_global_features_query,match_features
from hloc import pairs_from_prior_guided_retrieval, eval
from hloc import check, match
from hloc import ray_casting, undistort,localize_sensloc_loftr_withgravity, localize_sensloc_loftr, ray_casting_new
...
_, loc_matches= match_dense.main(
    matcher_conf, loc_pairs, images_db, images_query_w, outputs, max_kps= 8192, overwrite=False)
...
## ======== with gravity PnP ==========
localize_sensloc_loftr_withgravity.main(
    query_intrinsics,
    loc_pairs,
    loc_matches,
    eval_results,
...
ray_casting_new.main(config["ray_casting"], eval_results, detect_intrinsics, results_position, center_points_list, z_w_match)
