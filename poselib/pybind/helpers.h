...
void update_ransac_options(const py::dict &input, RansacOptions &ransac_opt) {
    ...
    update(input, "use_gravity_axis", ransac_opt.use_gravity_axis);
    update(input, "gravity_axis", ransac_opt.gravity_axis);
    update(input, "gravity_thresh", ransac_opt.gravity_thresh);
}
...
void write_to_dict(const RansacOptions &ransac_opt, py::dict &dict) {
    ...
    dict["use_gravity_axis"] = ransac_opt.use_gravity_axis;
    dict["gravity_axis"] = ransac_opt.gravity_axis;
    dict["gravity_thresh"] = ransac_opt.gravity_thresh;
}
