...
std::pair<Eigen::Matrix<double, 3, 4>, py::dict> estimate_absolute_pose_wrapper(const std::vector<Eigen::Vector2d> points2D,
    ...
    return std::make_pair(pose.Rt(), output_dict);
}
